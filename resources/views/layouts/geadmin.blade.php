    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{!!URL::to('/')!!}"><img src="../../images/pelicula.gif" alt="Amino-Cinema" height="30px" width="100px" /></a>
            </div>
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    ...
                    @endif
                        ...
                        <li>
                            <a href="#"><i class="fa fa-child fa-fw"></i>Peliculas y valoracion<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{!!URL::to('/genero/create')!!}"><i class='fa fa-plus fa-fw'></i> Agregar</a>
                                </li>
                                 <li>
                                    <a href="{!!URL::to('/genero')!!}"><i class='fa fa-list-ol fa-fw'></i> Peliculas</a>
                                </li>
                            </ul>
                        </li>
                    </ul>
